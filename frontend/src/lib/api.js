...
export const api = {
  ...
  actualizarAnticipoRequerido: (proyectoId, anticipoPct) => pedir(`/api/proyectos/${proyectoId}/cobranza/anticipo`, { method: 'PATCH', body: JSON.stringify({ anticipoPct }) }),
  instalacionesDeProyecto: (proyectoId) => pedir(`/api/proyectos/${proyectoId}/instalaciones`),
  crearInstalacion: (proyectoId, datos) => pedir(`/api/proyectos/${proyectoId}/instalaciones`, { method: 'POST', body: JSON.stringify(datos) }),
  actualizarInstalacion: (instalacionId, cambios) => pedir(`/api/instalaciones/${instalacionId}`, { method: 'PATCH', body: JSON.stringify(cambios) }),
  actualizarEstadoInstalacion: (instalacionId, estado) => pedir(`/api/instalaciones/${instalacionId}/estado`, { method: 'PATCH', body: JSON.stringify({ estado }) }),
  actualizarChecklistItem: (instalacionId, clave, completado) => pedir(`/api/instalaciones/${instalacionId}/checklist`, { method: 'PATCH', body: JSON.stringify({ clave, completado }) }),
  equiposDeProyecto: (proyectoId) => pedir(`/api/proyectos/${proyectoId}/equipos`),
  crearEquipoInstalado: (instalacionId, datos) => pedir(`/api/instalaciones/${instalacionId}/equipos`, { method: 'POST', body: JSON.stringify(datos) }),
